...
class KafkaManager(val kafkaParams: Map[String, String]) extends Serializable {
  ...
  (ssc: StreamingContext, kafkaParams: Map[String, String], topics: Set[String]): InputDStream[(K, V)] =  {
    ...
    val messages = {
      ...
      print("consumerOffsets："+consumerOffsets)
  ...
  /** 更新zookeeper上的消费offsets @param rdd @param offsetRanges */
  def updateZKOffsets(rdd: RDD[(String, String)], offsetRanges: Array[OffsetRange]) : Unit = {
    val groupId = kafkaParams.get("group.id").get //val offsetsList = rdd.asInstanceOf[HasOffsetRanges].offsetRanges
